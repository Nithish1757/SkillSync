	...
	<body>
		<div class="container">
			<a href=""><img class="logo"
					src="https://i.ibb.co/7Xyj3PC/logo.png" alt="SkillSync-Nithish  Logo"></a>
			<div class="message">OTP Verification Email</div>
			<div class="body">
				<p>Dear ${name}</p>
				<p>Thank you for registering with SkillSync-Nithish . To complete your registration, please use the following OTP
